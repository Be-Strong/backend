...
for (var i = 0; i < allusers.length; i++) { 
    allusers[i].points = 0;
       ...
       if(allusers[i].language === properties[0].value && allusers[i].language)
       {
       allusers[i].points +=  Math.exp(-properties[0].position)
       }
       if(allusers[i].age >= properties[1].value &&  allusers[i].age <= properties[2].value && allusers[i].age)
       {
       allusers[i].points +=  Math.exp(-properties[1].position)
       }
       if(allusers[i].country === properties[3].value && allusers[i].country)
       {
       allusers[i].points +=  Math.exp(-properties[3].position)
       }
       if(allusers[i].state === properties[4].value && allusers[i].state)
       {
       allusers[i].points +=  Math.exp(-properties[4].position )
       }
       if(allusers[i].city === properties[5].value && allusers[i].city ){
       allusers[i].points +=  Math.exp(-properties[5].position)
       }
       if(allusers[i].status === properties[6].value && allusers[i].status ){
       allusers[i].points +=  Math.exp(-properties[6].position)
       }
       if(allusers[i].cancertype === properties[7].value && allusers[i].cancertype)
       {
       allusers[i].points +=  Math.exp(-properties[7].position)
       }
       if(allusers[i].cancersubtype === properties[8].value && allusers[i].cancersubtype){
       allusers[i].points +=  Math.exp(-properties[8].position)
       }
       if(allusers[i].role === properties[9].value && allusers[i].role){
       allusers[i].points +=  Math.exp(-properties[9].position)
       }
       if(allusers[i].treatments === properties[10].value && allusers[i].treatments){
       allusers[i].points +=  Math.exp(-properties[10].position)
       }
       if(allusers[i].occupation === properties[11].value && allusers[i].occupation){
       allusers[i].points +=  Math.exp(-properties[11].position)
       }
       if(allusers[i].gender === properties[12].value && allusers[i].gender ){
